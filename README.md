...
| Phase | 期間 | 目標 | 状態 |
|-------|------|------|------|
| **P0 PoC** | 1-2w | インフラ構築、フック設置、E2E疎通確認 | **完了** |
| **P1 導入** | 1-2w | 完全パーミッシブ。全操作をログ記録し、行動ベースラインを蓄積 | 進行中 |
| P2 ルール化 | 1-2w | 初期ルール定義（パーミッシブ）。WOULD_BLOCK イベント蓄積開始 | 未着手 |
| P3 エンフォーシング | 2-4w | FP率10%未満のルールをエンフォーシングに昇格 | 未着手 |
| P4 定常運用 | -- | 成熟ルールセットで継続運用。新ルールのみパーミッシブで開始 | 未着手 |
